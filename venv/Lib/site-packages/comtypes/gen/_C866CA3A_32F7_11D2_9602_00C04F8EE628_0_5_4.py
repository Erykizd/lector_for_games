...
__all__ = [
    'eLEXTYPE_RESERVED6', 'SAFTNonStandardFormat', 'ISpPhraseAlt',
    'DISPID_SVPause', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SVAlertBoundary', 'SP_VISEME_5', 'SPEI_RESERVED6',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SPEDisplayText',
    'SPRS_ACTIVE_USER_DELIMITED', 'DISPID_SRGReset',
    'SpTextSelectionInformation', 'SAFT11kHz16BitStereo',
    'ISequentialStream', 'SpeechRunState',
    'SpeechAudioFormatGUIDWave', 'SAFT16kHz16BitStereo',
    'SPADAPTATIONRELEVANCE', 'DISPID_SOTGetAttribute',
    'DISPID_SLPs_NewEnum', 'SGRSTTWord', 'SpObjectTokenCategory',
    'SDTDisplayText', 'SPTEXTSELECTIONINFO',
    'DISPID_SpeechRecognizerStatus', 'LONG_PTR', 'ISpeechPhraseRule',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPID_SWFEFormatTag',
    'SpeechWordType', 'DISPID_SPPName', 'eWORDTYPE_ADDED', 'SPSVerb',
    'SpeechAudioFormatGUIDText', 'SP_VISEME_2', 'DISPID_SRCPause',
    'DISPID_SPARecoResult', 'ISpeechPhraseProperty', 'eLEXTYPE_USER',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SRRTOffsetFromStart',
    'DISPIDSPTSI_ActiveLength', 'SVF_Emphasis', 'DISPID_SAVolume',
    'SPDKL_CurrentUser', 'SpeechTokenKeyUI',
    'DISPID_SRGDictationLoad', 'SVESentenceBoundary',
    'ISpeechGrammarRuleStateTransitions',
    'DISPID_SLGetPronunciations', 'DISPID_SPPsCount', 'SPRULE',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SRGetRecognizers',
    'SAFTADPCM_8kHzStereo', 'SPEI_SOUND_START', 'DISPID_SPRsItem',
    'DISPID_SVResume', 'SAFT16kHz8BitMono', 'DISPID_SVAudioOutput',
    'SPPS_Interjection', 'DISPID_SRCEStartStream',
    'DISPID_SRCERecognitionForOtherContext', 'eLEXTYPE_PRIVATE1',
    'SPDKL_CurrentConfig', 'eLEXTYPE_PRIVATE3', 'DISPID_SGRsDynamic',
    'SpeechRegistryUserRoot', 'DISPID_SOTGetStorageFileName',
    'DISPID_SOTId', 'DISPID_SVDisplayUI', 'SPDKL_DefaultLocation',
    'SpeechEmulationCompareFlags', 'SVP_18', 'SVP_21',
    'DISPID_SDKOpenKey', 'SPPS_RESERVED4', 'DISPID_SPAs_NewEnum',
    'DISPID_SPRuleConfidence', 'SpeechDiscardType', 'SPPS_Unknown',
    'DISPID_SLRemovePronunciationByPhoneIds', 'SPWAVEFORMATTYPE',
    'SRSActiveAlways', 'DISPID_SPRuleChildren', 'SPPROPERTYINFO',
    'DISPID_SASState', 'SREAllEvents', 'SPCS_DISABLED',
    'ISpProperties', 'SPRECOSTATE', 'SVP_7',
    'SWPUnknownWordUnpronounceable', 'SVP_4', 'SPAUDIOBUFFERINFO',
    'SPLO_DYNAMIC', 'DISPID_SRGSetWordSequenceData',
    'DISPID_SREmulateRecognition', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SpeechBaseStream', 'SPEI_MAX_SR', 'DISPID_SRGRecoContext',
    'SRAImport', 'SpeechPropertyResourceUsage',
    ...
    'DISPID_SMSGetData', 'SpeechCategoryPhoneConverters',
    'STSF_FlagCreate', 'tagSPPROPERTYINFO', 'ISpeechPhraseProperties',
    'DISPID_SGRSTType', 'SPPS_SuppressWord', 'DISPID_SPRFirstElement',
    'DISPID_SRGId', 'DISPID_SpeechVoiceStatus',
    'SAFTCCITT_uLaw_22kHzMono', 'SAFT32kHz16BitMono',
    'SPGS_EXCLUSIVE', 'SSFMOpenForRead', 'SGRSTTWildcard', 'SPSNoun',
    'ISpeechPhoneConverter', 'DISPID_SPPEngineConfidence',
    'SPLEXICONTYPE', 'DISPID_SWFEBlockAlign', 'DISPID_SVEStreamStart',
    'SDTAlternates', 'SAFT44kHz16BitStereo',
    'DISPID_SpeechRecoResult2', 'SECFIgnoreWidth',
    'DISPID_SPERequiredConfidence', 'SPEI_FALSE_RECOGNITION',
    'DISPID_SpeechPhoneConverter', 'SPCT_SLEEP', 'SAFT44kHz16BitMono',
    'DISPID_SFSClose', 'SVEPhoneme', 'SPAS_RUN', 'ISpRecoContext2',
    'SPEI_START_INPUT_STREAM', 'SPRST_INACTIVE', 'SSTTDictation',
    'SPCT_SUB_DICTATION', 'SAFTADPCM_44kHzStereo',
    'eLEXTYPE_RESERVED10', 'DISPID_SLAddPronunciation',
    'SAFTCCITT_uLaw_11kHzMono', 'DISPID_SPILanguageId',
    ...
    'SPWORDTYPE', 'DISPID_SPRuleFirstElement', 'STSF_CommonAppData',
    'DISPID_SVSInputSentencePosition', 'SVSFIsXML',
    'SpNullPhoneConverter', 'DISPID_SRRecognizer', 'SITooLoud',
    'DISPID_SOTIsUISupported', 'eLEXTYPE_VENDORLEXICON',
    'SPEI_PROPERTY_NUM_CHANGE', 'SREHypothesis',
    'DISPID_SpeechDataKey', 'SAFTExtendedAudioFormat',
    'DISPID_SPEAudioSizeTime', 'ISpeechGrammarRuleState', 'SPSMF_UPS',
    'DISPID_SOTCDefault', 'SpeechStreamFileMode', 'SREInterference',
    'SP_VISEME_12', 'SPSEMANTICERRORINFO', 'DISPID_SpeechMMSysAudio',
    'SSTTTextBuffer', 'SECFIgnoreCase', 'SPWORDLIST', 'SPSHT_OTHER',
    'SAFT22kHz8BitStereo', 'SVP_15', 'SPFM_NUM_MODES', 'SP_VISEME_1',
    'DISPID_SLAddPronunciationByPhoneIds', 'UINT_PTR',
    'DISPID_SPERetainedStreamOffset', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SRDisplayUI', 'ISpXMLRecoResult', 'SpResourceManager',
    'SPAS_STOP', 'DISPID_SPRuleParent', 'SPPS_Noncontent',
    'SpeechAllElements', 'DISPID_SOTDataKey', 'ISpeechVoice',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SpeechPhraseAlternate', 'SSSPTRelativeToStart',
    'SPCT_SUB_COMMAND', 'SAFTCCITT_ALaw_11kHzMono', 'SWTAdded',
    'DISPID_SRCEPropertyStringChange', 'SLOStatic',
    'DISPID_SGRSTsItem', 'SPPHRASEPROPERTY', '_RemotableHandle',
    'SRERecognition', 'SPSInterjection', 'SpeechRecoEvents',
    'SAFTADPCM_22kHzMono', 'SPVPRIORITY',
    'DISPID_SABIMinNotification', 'WAVEFORMATEX',
    'SPPHRASEREPLACEMENT', 'SPFM_OPEN_READONLY', 'SpeechFormatType',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SVGetProfiles',
    'SPGS_DISABLED', 'SPSHORTCUTPAIRLIST', 'ISpeechObjectTokens',
    'SPBO_TIME_UNITS', 'DISPID_SVWaitUntilDone',
    'DISPID_SDKGetlongValue', 'SPEI_TTS_AUDIO_LEVEL',
    'DISPID_SDKEnumValues', 'ISpRecoGrammar', 'SASClosed',
    'SPRECOCONTEXTSTATUS', 'DISPID_SRGetPropertyString',
    'SAFT24kHz16BitStereo', 'ISpeechPhraseInfo', 'eWORDTYPE_DELETED',
    'STSF_LocalAppData', 'SPINTERFERENCE_TOOLOUD',
    'SpeechVisemeFeature', 'DISPID_SRCState', 'SpNotifyTranslator',
    'SP_VISEME_4', 'DISPID_SMSAMMHandle', 'ISpSerializeState',
    'eLEXTYPE_RESERVED8', 'SRAONone', 'ISpeechVoiceStatus',
    'SPRS_ACTIVE', 'ISpeechAudioFormat', 'SAFT12kHz8BitStereo',
    'DISPID_SpeechAudio', 'SREFalseRecognition', 'SGPronounciation',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SpeechAudioFormatType', 'DISPID_SRCESoundStart',
    'SpeechStreamSeekPositionType', 'DISPID_SRRAlternates',
    'SAFTCCITT_uLaw_8kHzMono', 'SPEI_UNDEFINED',
    'SREPropertyStringChange', 'eLEXTYPE_PRIVATE19',
    'ISpObjectTokenCategory', 'DISPID_SOTsItem',
    'ISpPhoneticAlphabetSelection', 'DISPID_SGRSTText',
    'DISPID_SPRules_NewEnum', 'DISPID_SLWsItem', 'SVF_None',
    'SP_VISEME_16', 'SAFTCCITT_ALaw_8kHzStereo', 'SSSPTRelativeToEnd',
    'SP_VISEME_11', 'SDA_One_Trailing_Space', 'SpeechLexiconType',
    'DISPID_SPRulesCount', 'SpeechCategoryAudioOut',
    'DISPID_SGRSAddRuleTransition', 'SPEVENTSOURCEINFO',
    'DISPID_SRCEEndStream', 'DISPID_SDKCreateKey', 'SRSEIsSpeaking',
    'SpeechRecognizerState', 'SP_VISEME_17', 'SPSModifier',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SRSNumberOfActiveRules',
    'SpeechInterference', 'SPPS_Verb', 'DISPID_SVEAudioLevel',
    'DISPID_SASetState', 'SpeechTokenIdUserLexicon', 'SVP_6',
    'DISPID_SAFType', 'DISPID_SRRRecoContext', 'SVSFNLPMask',
    'ISpeechAudioStatus', 'SPWORDPRONUNCIATION',
    'DISPID_SLGetGenerationChange', 'ISpeechLexiconWord',
    'SINoSignal', 'DISPID_SpeechRecognizer', 'DISPID_SPPs_NewEnum',
    'DISPID_SRCEventInterests', 'SP_VISEME_14', 'DISPID_SLPPhoneIds',
    'DISPID_SRGState', 'SVP_19', 'DISPID_SOTsCount',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SRCCreateGrammar',
    'DISPID_SAEventHandle', 'SPEI_RESERVED3', 'SVPNormal',
    'SPSHT_NotOverriden', 'SWPUnknownWordPronounceable',
    'eLEXTYPE_LETTERTOSOUND', 'DISPID_SGRSTPropertyId',
    'DISPID_SPPParent', 'DISPID_SGRs_NewEnum', 'DISPID_SLGetWords',
    'SGDSActiveWithAutoPause', 'SGDisplay', 'eLEXTYPE_PRIVATE9',
    ...
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SRTExtendableParse',
    'SASPause', 'DISPID_SBSRead', 'SPPS_RESERVED1', 'DISPID_SPAsItem',
    'ISpeechResourceLoader', 'SPFM_CREATE', 'Speech_StreamPos_Asap',
    'SDTPronunciation', 'ISpeechRecognizer', 'SPPS_Function',
    'SECLowConfidence', 'SPEI_TTS_PRIVATE', 'DISPID_SGRName',
    'STCInprocServer', 'SAFT44kHz8BitMono', 'SPVPRI_NORMAL',
    'SVEViseme', 'IEnumString', 'SVP_2', 'ISpeechPhraseReplacement',
    'SPEI_SR_RETAINEDAUDIO', 'SPAO_RETAIN_AUDIO', 'SPBO_NONE',
    'SPVOICESTATUS', 'SPSHT_Unknown', 'ISpeechPhraseRules',
    'SPINTERFERENCE_NONE', 'DISPID_SLWPronunciations', 'SpFileStream',
    'DISPID_SPIEngineId', 'SPXRO_SML', 'DISPID_SpeechFileStream',
    'SpeechDictationTopicSpelling', 'eLEXTYPE_MORPHOLOGY', 'SASRun',
    'ISpeechPhraseReplacements', 'SAFTTrueSpeech_8kHz1BitMono',
    'SDKLDefaultLocation', 'SVP_9', 'DISPID_SOTCId',
    'DISPID_SADefaultFormat', 'SpeechAddRemoveWord', 'SPAS_CLOSED',
    'DISPID_SpeechAudioStatus', 'eLEXTYPE_PRIVATE16',
    'DISPID_SPEPronunciation', 'SAFT48kHz8BitMono',
    'SAFTCCITT_ALaw_44kHzStereo',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SVP_0',
    'SPEI_RECO_STATE_CHANGE', 'DISPID_SDKSetBinaryValue',
    'DISPID_SRRPhraseInfo', 'SAFTCCITT_uLaw_8kHzStereo', 'SINone',
    'SGDSActive', 'DISPID_SVGetAudioInputs',
    'SpeechVoiceCategoryTTSRate', 'DISPID_SWFEChannels',
    'DISPID_SMSSetData', 'SVP_14', 'SPSHT_EMAIL',
    'DISPID_SpeechLexiconWords', 'SDKLLocalMachine',
    'SECNormalConfidence', 'DISPID_SRCEPhraseStart', 'SLTUser',
    'DISPID_SVSLastStreamNumberQueued', 'SpMMAudioIn',
    'DISPID_SDKEnumKeys', '__MIDL_IWinTypes_0009', 'DISPID_SRState',
    'SPLOADOPTIONS', 'SITooSlow', 'SVPAlert', 'SDTAll',
    'DISPID_SPIGrammarId', 'SpeechPartOfSpeech', 'DISPID_SFSOpen',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SASNonBlockingIO',
    'SVSFParseSsml', 'DISPID_SRGDictationUnload', 'SGSDisabled',
    'DISPID_SRCRetainedAudioFormat', 'SpeechLoadOption',
    'SAFT44kHz8BitStereo', 'DISPID_SVEEnginePrivate',
    'SSFMCreateForWrite', 'DISPID_SDKGetStringValue',
    'DISPID_SRRSaveToMemory', 'SRTEmulated', 'eLEXTYPE_PRIVATE7',
    'SpeechGrammarTagWildcard', 'SpeechVoiceSpeakFlags',
    'DISPID_SRProfile', 'DISPID_SPEActualConfidence',
    'DISPID_SLPsCount', 'DISPID_SCSBaseStream', 'SPEI_WORD_BOUNDARY',
    'SPBINARYGRAMMAR', 'SITooFast', 'SAFT11kHz8BitMono',
    'DISPID_SPAPhraseInfo', 'eLEXTYPE_PRIVATE5', 'DISPID_SVSVisemeId',
    'ISpStreamFormat', 'ISpeechPhraseElement', 'SVSFUnusedFlags',
    'SPAUDIOSTATE', 'SpMemoryStream', 'SVPOver', 'SpMMAudioEnum',
    'SAFTGSM610_8kHzMono', 'ISpeechDataKey', 'SpSharedRecognizer',
    'DISPID_SVRate', 'SPEI_PHRASE_START', 'SDTProperty',
    'DISPID_SPACommit', 'DISPID_SPRNumberOfElements',
    'DISPID_SVSInputWordPosition', 'SRSActive',
    'SpeechTokenKeyAttributes', 'SPCT_COMMAND', 'SPRST_ACTIVE_ALWAYS',
    'SPCS_ENABLED', 'SAFT8kHz16BitStereo',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SpeechEngineProperties',
    'DISPIDSPTSI', 'DISPID_SVSLastBookmark', 'SPEI_PHONEME', 'SPWORD',
    'DISPID_SRCEAdaptation', 'DISPID_SpeechRecoContextEvents',
    'ISpeechAudio', 'SAFT32kHz8BitMono', 'DISPID_SVSRunningState',
    'ISpeechTextSelectionInformation', 'SDKLCurrentConfig',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SVEVoiceChange',
    'DISPID_SOTs_NewEnum', 'DISPID_SVStatus', 'SVEEndInputStream',
    'ISpShortcut', 'SAFTCCITT_uLaw_44kHzStereo', 'SPBO_PAUSE',
    'SPPS_NotOverriden', 'ISpeechMemoryStream',
    'DISPIDSPTSI_SelectionLength', 'SpStream',
    'DISPID_SOTRemoveStorageFileName', 'IEnumSpObjectTokens',
    'SREAudioLevel', 'SpeechBookmarkOptions', 'SAFTGSM610_11kHzMono',
    'DISPID_SRSetPropertyNumber', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SpeechObjectToken', 'ISpeechGrammarRule', 'SVSFlagsAsync',
    'DISPID_SRGCommit', 'SpVoice', 'tagSPTEXTSELECTIONINFO',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SDKDeleteKey', 'SDTRule',
    'DISPID_SRSCurrentStreamPosition', 'DISPID_SGRsCount',
    'DISPID_SVESentenceBoundary', 'SVEPrivate', 'SPAS_PAUSE',
    'DISPID_SRCSetAdaptationData', 'DISPID_SVSpeakCompleteEvent',
    'ISpPhrase', 'DISPIDSPRG', 'SpeechPropertyComplexResponseSpeed',
    'SRCS_Disabled', 'eLEXTYPE_RESERVED9',
    'DISPID_SVSInputSentenceLength', 'ISpeechCustomStream',
    'DISPID_SGRInitialState', 'DISPID_SGRSTransitions',
    'DISPID_SPPId', 'ISpeechLexiconPronunciation', 'STCRemoteServer',
    'SSFMCreate', 'SPWF_SRENGINE', 'ISpRecognizer',
    'DISPID_SpeechPhraseElement', 'eLEXTYPE_PRIVATE4', 'SP_VISEME_7',
    'SPEI_SR_AUDIO_LEVEL', 'SPVISEMES',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SPRs_NewEnum', 'SPEI_RECOGNITION', 'SP_VISEME_15',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'DISPID_SpeechAudioBufferInfo', 'SITooQuiet',
    'SPRECOGNIZERSTATUS', 'SGLexical', 'SGDSInactive',
    'SPXMLRESULTOPTIONS', 'DISPID_SRCEBookmark',
    'DISPID_SPISaveToMemory', 'DISPID_SMSALineId',
    'eLEXTYPE_PRIVATE14', 'SpAudioFormat', 'DISPID_SGRsFindRule',
    'SGRSTTTextBuffer', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SOTCSetId', 'DISPID_SPCIdToPhone', 'SVP_17',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPIDSPTSI_SelectionOffset',
    'SpeechTokenValueCLSID', 'SRAExport', 'SREPropertyNumChange',
    'SPEI_REQUEST_UI', 'SAFTCCITT_uLaw_44kHzMono', 'SVSFParseMask',
    'DISPID_SRCEHypothesis', 'eLEXTYPE_PRIVATE15', 'ISpRecognizer3',
    'DISPID_SRCCreateResultFromMemory',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'DISPID_SRIsUISupported',
    'SPAR_Low', 'DISPID_SPEDisplayAttributes', 'DISPID_SPEsCount',
    'DISPID_SGRAttributes', 'ISpRecoGrammar2', 'DISPID_SLWs_NewEnum',
    '_ISpeechVoiceEvents', 'DISPID_SABufferNotifySize',
    'SpeechGrammarTagDictation', 'DISPID_SGRsAdd',
    'SPEI_END_SR_STREAM', 'SPSERIALIZEDPHRASE', 'eLEXTYPE_PRIVATE11',
    'SECFIgnoreKanaType', 'eLEXTYPE_RESERVED7',
    'ISpStreamFormatConverter', 'DISPID_SGRClear', 'DISPID_SPEsItem',
    'SPSERIALIZEDRESULT', 'Speech_StreamPos_RealTime',
    'DISPID_SRCVoicePurgeEvent', 'ISpeechAudioBufferInfo',
    'DISPID_SRCEPropertyNumberChange', 'SAFTGSM610_44kHzMono',
    'DISPID_SPEAudioTimeOffset', 'SAFTADPCM_11kHzStereo',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SRStatus',
    'SRTAutopause', 'ISpeechGrammarRules', 'ISpRecoResult',
    'DISPID_SPCLangId', 'SP_VISEME_9',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SVSFIsNotXML',
    'SPRST_INACTIVE_WITH_PURGE', 'ISpeechPhraseAlternates',
    'SAFT16kHz8BitStereo', 'SPAO_NONE', 'DISPID_SRCRetainedAudio',
    'DISPID_SPEs_NewEnum', 'DISPID_SRGetPropertyNumber',
    'DISPID_SAFGuid', 'SpObjectToken', 'DISPID_SPIRule',
    'eLEXTYPE_RESERVED4', 'DISPID_SMSADeviceId',
    'SAFTNoAssignedFormat', 'SpPhoneConverter',
    'SpeechPropertyHighConfidenceThreshold', 'SLTApp', 'SP_VISEME_0',
    'SGDSActiveUserDelimited', 'eLEXTYPE_PRIVATE13',
    'DISPID_SRRAudio', 'ISpNotifySource', 'SPGRAMMARSTATE',
    'ISpeechMMSysAudio', 'SRSEDone', 'SBONone', 'SPWORDPRONOUNCEABLE',
    'SP_VISEME_6', 'SDTAudio', 'DISPID_SRCERequestUI',
    'DISPID_SPIElements', 'STCAll', 'ISpeechRecoResultTimes', 'SVP_5',
    'SAFT16kHz16BitMono', 'ISpGrammarBuilder', 'SAFTText',
    'DISPID_SRSetPropertyString', 'DISPID_SDKDeleteValue',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SRGCmdSetRuleIdState',
    ...
    'DISPID_SLPsItem', 'SAFT11kHz8BitStereo',
    'DISPID_SRGCmdSetRuleState', 'ISpRecoCategory',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRCERecognition',
    'DISPID_SAStatus', 'SAFTADPCM_11kHzMono', 'SPSLMA', 'SP_VISEME_3',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'ISpeechRecoContext',
    'DISPID_SBSWrite', 'SpeechEngineConfidence',
    'SpPhoneticAlphabetConverter', 'DISPID_SOTCreateInstance',
    'DISPID_SLRemovePronunciation', 'SPBOOKMARKOPTIONS',
    'SPVPRI_ALERT', 'DISPID_SRRTLength', 'SpInprocRecognizer',
    'DISPID_SABIEventBias', 'SPSTREAMFORMATTYPE', 'IStream',
    'SAFT24kHz8BitStereo', 'SPINTERFERENCE',
    'ISpeechRecognizerStatus', 'SPWORDPRONUNCIATIONLIST',
    'DISPID_SpeechGrammarRule', 'SAFT8kHz8BitStereo',
    'DISPID_SDKSetLongValue', 'ISpeechRecoResult', '_SPAUDIOSTATE',
    'DISPID_SVSpeakStream', 'SPAUDIOSTATUS', 'SpeechTokenShellFolder',
    'SpeechCategoryAudioIn', 'DISPID_SDKSetStringValue',
    'eLEXTYPE_PRIVATE8', 'SPPS_Modifier', 'DISPID_SRIsShared',
    'SAFT24kHz16BitMono', 'DISPID_SPIGetDisplayAttributes',
    'SPEI_VOICE_CHANGE', 'SPSSuppressWord', 'SSFMOpenReadWrite',
    'SPAR_High', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'ISpRecoContext', 'Speech_Default_Weight', 'STCLocalServer',
    'SP_VISEME_18', 'SVSFVoiceMask', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SAFT22kHz16BitMono', 'DISPID_SOTSetId', 'DISPID_SRCResume',
    'DISPID_SRRGetXMLErrorInfo', 'SAFTCCITT_ALaw_22kHzStereo',
    'DISPID_SRCEInterference', 'DISPID_SLWWord',
    'SpeechSpecialTransitionType',
    'ISpeechGrammarRuleStateTransition', 'SP_VISEME_8',
    'SAFTCCITT_ALaw_44kHzMono', 'SPEI_START_SR_STREAM',
    'DISPID_SOTRemove', 'DISPID_SPIProperties',
    'IInternetSecurityManager', 'SAFT48kHz16BitStereo',
    'eLEXTYPE_PRIVATE17', 'ISpeechLexiconPronunciations',
    'SPRS_INACTIVE', 'SREStateChange',
    'DISPID_SPAStartElementInResult', 'SGSEnabled',
    'DISPID_SPRulesItem', 'ISpNotifySink', 'SPEI_SR_PRIVATE',
    'DISPID_SLGenerationId', 'SVEBookmark', 'SGRSTTRule',
    'SPINTERFERENCE_LATENCY_WARNING', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SLPType', 'SVSFPersistXML', 'ISpeechObjectToken',
    ...
    'SpeechRecognitionType', 'SpeechVoiceEvents',
    'SRERecoOtherContext', 'SpeechPropertyAdaptationOn',
    'SVEAudioLevel', 'SpeechRecoContextState', 'SpeechRuleState',
    'DISPID_SpeechObjectTokens', 'DISPID_SVEventInterests',
    'DISPID_SPIStartTime', 'DISPID_SPRuleNumberOfElements',
    'SPGRAMMARWORDTYPE', 'SDA_Two_Trailing_Spaces',
    'SAFT11kHz16BitMono', 'ISpAudio', 'SPPHRASERULE',
    'SPFM_CREATE_ALWAYS', 'SPEI_RESERVED2', 'SPSHORTCUTPAIR',
    'SAFT48kHz16BitMono', 'DISPID_SRSSupportedLanguages',
    'DISPID_SVSLastResult', 'SREBookmark', 'ISpRecognizer2',
    'SVSFParseAutodetect', 'DISPID_SRCBookmark', 'SP_VISEME_21',
    'SAFT8kHz8BitMono', 'DISPID_SAFSetWaveFormatEx', 'ISpDataKey',
    'DISPID_SGRSTs_NewEnum', 'SpCompressedLexicon',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SWFEExtraData',
    'DISPID_SABufferInfo', 'SPEI_MAX_TTS',
    'SDA_Consume_Leading_Spaces', 'ISpEventSource', 'SINoise',
    'SRESoundEnd', 'SVEVoiceChange', 'SP_VISEME_20',
    'SAFTADPCM_44kHzMono', 'DISPID_SpeechVoice', 'DISPID_SBSSeek',
    'SpeechGrammarState', 'SpeechRegistryLocalMachineRoot',
    'SRCS_Enabled', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SRRTStreamTime', 'SPFM_OPEN_READWRITE', 'SPPARTOFSPEECH',
    'DISPID_SPRuleName', 'SpeechAudioProperties', 'SAFT24kHz8BitMono',
    'SRADynamic', 'DISPID_SLWType', 'STCInprocHandler',
    'SREPhraseStart', 'DISPID_SVSLastBookmarkId',
    'SPINTERFERENCE_TOOFAST', 'SAFTGSM610_22kHzMono',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SVEStreamEnd',
    'SPGS_ENABLED', 'SVP_10', 'DISPID_SpeechLexicon', 'SPAR_Unknown',
    'SWTDeleted', 'SPFILEMODE', 'SVP_3', 'SpLexicon',
    'SPRST_NUM_STATES', 'SAFT32kHz16BitStereo', 'DISPID_SLPLangId',
    'ISpPhoneConverter', 'SVSFPurgeBeforeSpeak',
    'DISPID_SPELexicalForm', 'DISPID_SpeechPhraseAlternates',
    'SpCustomStream', 'DISPID_SVEWord', 'DISPID_SpeechRecoContext',
    'SPEI_ADAPTATION', 'SAFT12kHz16BitStereo',
    'DISPID_SPPFirstElement', 'DISPID_SRRTTickCount',
    'DISPID_SPCPhoneToId', 'SPCATEGORYTYPE',
    'DISPID_SWFEBitsPerSample', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SOTCategory', 'DISPID_SPAsCount',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SpeechGrammarRules',
    'DISPID_SVSkip', 'SPSUnknown', 'SPEI_SENTENCE_BOUNDARY',
    'SRTReSent', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SpeechMemoryStream', 'SPEI_SR_BOOKMARK',
    'ISpeechXMLRecoResult', 'DISPID_SVAudioOutputStream',
    'DISPID_SVVoice', 'SGRSTTEpsilon', 'SFTSREngine',
    'Speech_Max_Word_Length', 'SPCONTEXTSTATE', 'SpWaveFormatEx',
    'SpeechVoicePriority', 'SP_VISEME_10', 'SVP_8', 'SVP_20',
    'SDTLexicalForm', 'eLEXTYPE_PRIVATE20', 'SPEI_MIN_TTS',
    'DISPID_SPPsItem', 'ISpLexicon', 'SGLexicalNoSpecialChars',
    'ISpeechObjectTokenCategory', 'DISPID_SGRsCommit', 'SPWT_LEXICAL',
    'SPEI_HYPOTHESIS', 'DISPID_SOTDisplayUI', 'DISPID_SBSFormat',
    'SAFTADPCM_22kHzStereo', 'SpInProcRecoContext',
    'SAFT22kHz8BitMono', 'ISpeechLexiconWords',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'SpeechPropertyResponseSpeed', 'SPLO_STATIC', 'SPEVENTENUM',
    'DISPID_SPERetainedSizeBytes', 'tagSTATSTG',
    'ISpeechPhraseElements', 'DISPID_SGRSAddWordTransition',
    'DISPID_SASCurrentDevicePosition', 'SPRECORESULTTIMES',
    'DISPID_SVSyncronousSpeakTimeout', 'SAFTCCITT_ALaw_11kHzStereo',
    'eLEXTYPE_APP', 'DISPID_SPIReplacements', 'SVSFParseSapi',
    'SpPhraseInfoBuilder', 'SRAORetainAudio', 'DISPID_SABIBufferSize',
    'SVSFIsFilename', '_ISpeechRecoContextEvents',
    'SWPKnownWordPronounceable', 'DISPID_SPPConfidence',
    'DISPID_SpeechPhraseInfo', 'SPPS_Noun',
    'DISPID_SVSInputWordLength', 'STSF_AppData',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SPRText',
    'SREStreamStart', 'SVP_12', 'DISPID_SVEViseme',
    'DISPID_SGRSTNextState', 'DISPID_SpeechPhraseProperties', 'SVP_1',
    'SVP_11', 'SAFT32kHz8BitStereo', 'DISPID_SVVolume',
    'eLEXTYPE_PRIVATE2', 'SP_VISEME_13', 'SVP_13',
    'ISpeechPhraseAlternate', 'SAFT12kHz16BitMono',
    'ISpeechRecoResult2', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SRATopLevel', 'SFTInput', 'DISPID_SpeechPhraseElements',
    'DISPID_SRCRequestedUIType', 'DISPID_SOTCGetDataKey',
    'SAFT12kHz8BitMono', 'SPPHRASEELEMENT',
    'DISPID_SGRSTPropertyValue', 'SPWT_DISPLAY', 'DISPID_SVPriority',
    'DISPID_SPIEnginePrivateData', 'DISPID_SPRsCount',
    'eLEXTYPE_PRIVATE6', 'ISpeechLexicon', 'SRTSMLTimeout',
    'DISPID_SRGCmdLoadFromObject', 'SECFNoSpecialChars',
    'DISPID_SRRAudioFormat', 'DISPID_SGRsItem', 'SPSEMANTICFORMAT',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SGRsCommitAndSave',
    'SPEI_SOUND_END', 'DISPID_SRCEAudioLevel', 'DISPID_SLWsCount',
    'SRSInactive', 'DISPID_SOTMatchesAttributes',
    'IInternetSecurityMgrSite', 'DISPID_SpeechLexiconWord',
    'SAFTCCITT_uLaw_22kHzStereo', 'SpSharedRecoContext',
    'DISPID_SRGIsPronounceable', 'SpeechDataKeyLocation',
    'SPPS_RESERVED3', 'ISpStream', 'SPEI_MIN_SR',
    'eLEXTYPE_USER_SHORTCUT', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SASFreeBufferSpace',
    'DISPID_SRGDictationSetState', 'SPDKL_LocalMachine',
    'DISPID_SRCESoundEnd', 'DISPID_SPPNumberOfElements',
    'SpeechTokenContext', 'DISPID_SRCreateRecoContext',
    'ISpObjectWithToken', 'DISPID_SLWLangId', 'ISpResourceManager',
    'DISPID_SRGRules', 'SGRSTTDictation', 'SpeechAudioState',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SpeechPhraseRule',
    'SAFT48kHz8BitStereo', 'DISPID_SRRSpeakAudio',
    'DISPID_SVIsUISupported', 'SECHighConfidence',
    'ISpeechPhraseInfoBuilder', 'DISPID_SRCRecognizer',
    'DISPID_SRCEFalseRecognition', 'SpeechRetainedAudioOptions',
    'DISPID_SRAudioInputStream', 'DISPID_SpeechVoiceEvent',
    'DISPID_SVSPhonemeId', 'SRERequestUI', 'DISPID_SpeechPhraseRules',
    'DISPID_SGRAddResource', 'SPEI_RESERVED5',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SLPSymbolic',
    'ISpNotifyTranslator', 'SpeechGrammarWordType', 'ISpVoice',
    'SVEWordBoundary', 'DISPID_SGRSTsCount', 'SPRST_ACTIVE',
    'DISPID_SVSpeak', 'SRARoot', 'SpeechCategoryRecognizers',
    'DISPID_SOTCEnumerateTokens', 'eLEXTYPE_PRIVATE10',
    'ISpPhoneticAlphabetConverter',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPIAudioSizeTime', 'DISPID_SRRGetXMLResult',
    'DISPID_SGRSTWeight', 'DISPID_SRGetFormat',
    'DISPID_SpeechPhraseProperty', 'DISPID_SDKGetBinaryValue',
    'DISPID_SOTGetDescription', 'DISPID_SVEPhoneme',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SRSCurrentStreamNumber',
    'SRAInterpreter', 'DISPID_SGRAddState', 'SpeechWordPronounceable',
    'SPAUDIOOPTIONS', 'DISPID_SRCVoice', 'SPEI_RESERVED1',
    'SRESoundStart', 'DISPID_SRSAudioStatus', 'SBOPause',
    'SPSFunction', 'DISPID_SVEBookmark', 'SDKLCurrentUser',
    'SPPS_LMA', 'ISpeechWaveFormatEx', 'SpeechCategoryVoices',
    'DISPID_SGRSTRule', 'SECFEmulateResult',
    'SpStreamFormatConverter', 'SPRULESTATE', 'SASStop',
    'DISPID_SRRTimes', 'SPEI_TTS_BOOKMARK',
    'DISPID_SPRDisplayAttributes', 'DISPID_SRAudioInput',
    'SpMMAudioOut', 'DISPID_SRGCmdLoadFromFile', 'SPEI_VISEME',
    'SPWT_PRONUNCIATION', 'SRSInactiveWithPurge', 'ISpEventSink',
    'SVSFDefault', 'SREPrivate', 'SpUnCompressedLexicon',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SpeechCustomStream',
    'SPPS_RESERVED2', 'SpeechTokenKeyFiles',
    'SpeechRecoProfileProperties', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SpeechLexiconProns', 'SRTStandard', 'SPCT_DICTATION',
    'SPEI_END_INPUT_STREAM', 'Speech_Max_Pron_Length',
    'SREAdaptation', 'DISPID_SPPChildren', 'DISPID_SGRSRule',
    'SpeechMicTraining', 'SVEAllEvents', 'ISpeechFileStream',
    'SPDATAKEYLOCATION', 'SPPHRASE', 'DISPID_SPPValue',
    'DISPID_SRCCmdMaxAlternates', 'SPEI_INTERFERENCE', 'SPAR_Medium',
    'SAFTDefault', 'SPBO_AHEAD', 'SVF_Stressed', 'SDTReplacement',
    'SPSHORTCUTTYPE', 'SLODynamic', 'SRADefaultToActive',
    'ISpMMSysAudio', 'ISpeechRecoResultDispatch', 'DISPID_SGRId',
    'ISpeechRecoGrammar', 'SPXRO_Alternates_SML',
    'DISPID_SPEEngineConfidence', 'SVP_16', 'SPEVENT', 'SREStreamEnd',
    'SGSExclusive', 'DISPID_SPRuleId', 'SpShortcut', 'SP_VISEME_19',
    'DISPID_SRCAudioInInterferenceStatus', 'SPWF_INPUT',
    'SAFT22kHz16BitStereo', 'DISPID_SRCEEnginePrivate',
    'eLEXTYPE_PRIVATE12', 'ISpeechBaseStream', 'SECFDefault',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPVPRI_OVER',
    'SSTTWildcard', 'eLEXTYPE_PRIVATE18'
]

_check_version('1.1.14', 1655341979.221248)
